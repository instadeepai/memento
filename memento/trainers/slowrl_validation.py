...
from memento.trainers.trainer import ActingState, Information, generate_trajectory
from memento.trainers.validation import get_instances, get_params
from memento.utils.data import get_acting_keys
...
def slowrl_validate(
    ...
    if is_pomo:
        ...
        decoder_params = jax.tree_map(
            lambda x: jnp.repeat(x, cfg.pop_batch, axis=0), decoder_params
        )
