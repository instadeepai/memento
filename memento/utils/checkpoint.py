...
from memento.utils.utils import run_on_master
...
def load_checkpoint(cfg):
    ...
    if cfg.checkpointing.restore_path and cfg.checkpointing.restore_decoder:
        ...
        if old_population_size == cfg.training_sample_size:
            ...
            decoder_params = jax.tree_map(
                lambda x: jnp.concatenate([x] * cfg.training_sample_size, axis=0)[
            ...
            raise ValueError(
                ...
                " state with decoder params for {} agents.".format(
                    cfg.training_sample_size, cfg.training_sample_size
                )
            )
        else:
            raise ValueError(
