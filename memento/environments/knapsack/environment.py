...
from memento.environments.knapsack.utils import (
    compute_value_items,
    generate_problem,
)
from jumanji.types import TimeStep, restart, termination, transition

from memento.environments.knapsack.types import Observation, State
...
class PoppyKnapsack(Knapsack, PoppyEnv):
    ...
    def observation_spec(self) -> specs.Spec[Observation]:
        ...
        position = specs.DiscreteArray(self.num_items, dtype=jnp.int32, name="position")
    ...
    def _state_to_observation(self, state: State) -> Observation:
        ...
        return Observation(
            ...
            action_mask=state.packed_items | (state.remaining_budget < state.weights),
            is_done=(
